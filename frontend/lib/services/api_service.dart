...
class ApiService {
  ...
  Future<ChallengeList> getChallenges({
    ...
    try {
      ...
      final response = await _dio.get('/challenges', queryParameters: queryParams);
  ...
  Future<Challenge> updateChallenge(String challengeId, Challenge challenge) async {
    try {
      final response = await _dio.put('/challenges/$challengeId', data: challenge.toJson());
      return Challenge.fromJson(response.data);
    } on DioException catch (e) {
  ...
  Future<List<Submission>> getSubmissions({
    ...
    try {
      ...
      final response = await _dio.get('/submissions', queryParameters: queryParams);
      final List<dynamic> submissionsJson = response.data['submissions'] ?? response.data;
  ...
  Future<CodeExecutionResponse> executeCode(String challengeId, String code) async {
    try {
